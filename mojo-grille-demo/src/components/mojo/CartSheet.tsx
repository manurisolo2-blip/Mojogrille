  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <aside
        ...
        aria-modal="true"
        className="relative flex h-full w-full max-w-sm flex-col bg-cream-bg shadow-none"
      >
          ...
          {count === 0 ? (
            ...
            <ul className="space-y-3">
              {lines.map((line) => (
                <li
                  key={line.key}
                  className="grid grid-cols-[minmax(0,1fr)_auto] items-start gap-3 rounded-none bg-surface-sand p-3.5"
                >
                  <div className="min-w-0">
        ...
        <div className="px-5 py-4 bg-surface-sand">
