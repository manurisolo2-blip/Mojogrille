          ...
          <div className="flex shrink-0 items-center gap-2">
            <div ref={dropdownRef} className="relative">
              <button
                ...
                className="flex items-center gap-1.5 rounded-none border border-charcoal-ink/20 bg-surface-sand px-3 py-1.5 font-mono text-[11px] uppercase tracking-wider font-semibold text-charcoal-ink transition-colors hover:border-charcoal-ink hover:bg-cream-bg sm:px-3.5 sm:py-2"
              >
            ...
            <button
              ...
              className="relative grid h-11 w-11 place-items-center rounded-none border border-charcoal-ink bg-brand-fire text-cream-bg shadow-none transition-colors hover:bg-charcoal-ink"
            >
              <ShoppingBag className="h-5 w-5" />
              {count > 0 && (
                <span className="absolute -right-1 -top-1 grid h-5 min-w-5 place-items-center rounded-none border border-charcoal-ink bg-leaf-green px-1 font-mono text-[10px] font-bold text-cream-bg">
                  {count}
                </span>
              )}
              {count > 0 && (
                <span className="absolute inset-0 animate-ping rounded-none border border-brand-fire/40" />
              )}
            </button>
          </div>
        </nav>
