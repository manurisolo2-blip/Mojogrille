  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* CAPA 2: COMIDA QUE SE QUEDA ARRIBA (PAN TOSTADO CUBANO) */}
        <div
          ref={topFoodRef}
        ...
        {/* CAPA 3: TIPOGRAFÍA MONUMENTAL INTERMEDIA */}
        <div
          ref={titleLayerRef}
        ...
        {/* CAPA 4: COMIDA INFERIOR EN PRIMER PLANO */}
        <div
          ref={bottomFoodRef}
