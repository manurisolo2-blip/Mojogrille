      ...
      <div className="relative pt-10 pb-16 sm:pt-16 sm:pb-24">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              href={cateringHref}
              className="inline-flex items-center justify-center gap-2.5 rounded-full border border-charcoal-ink/20 bg-surface-sand px-7 py-4.5 font-sans text-base font-semibold text-charcoal-ink shadow-sm transition-all duration-200 hover:bg-surface-sand/80 hover:border-brand-fire/40 select-none"
            >
